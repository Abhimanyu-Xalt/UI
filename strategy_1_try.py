...
#--------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    for market in market_catalogue:
        ...
        last_price_traded,lay_bet_price = getBothPrice(market_book, selection_id)
        ...
        if LayBet_status == 'SUCCESS':
            while(True):
                time.sleep(600)
                back_bet_price , lay_bet_price = getBothPrice(market_book, selection_id)
                if lay_bet_price < last_price_traded :
                    lay_bet_list.append(lay_bet_price)
