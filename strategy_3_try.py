...
#-------------------------------------------------------------------------------------------------------------------------------------------------------
    def placeBackBet(marketId, selectionId, price, size):
        ...
        if( marketId is not None and selectionId is not None):
            ...
            return (place_order_result['status'],error_code, side, price)        
        # if place_order_result['status'] == 'FAILURE':
        #     return False
        # else :
        #     return True
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------
    for market in market_catalogue:
        ...
        # print('Back Bet')
        BackBet_status,Back_bet_reason,type,odds = placeBackBet(market_id, selection_id, last_price_traded, back_stake)
